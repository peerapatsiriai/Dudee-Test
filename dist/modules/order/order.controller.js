...
exports.getAllOrderByMemberId = void 0;
...
const getAllOrderByMemberId = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const memberId = req.memberID; // Get memberID from middleware
        const orders = yield orderService.getAllOrderByMemberId(Number(memberId));
